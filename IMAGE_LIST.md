...
모든 이미지는 `images/` 폴더에 JPG 형식으로 저장.
퍼블릭 도메인 또는 위키미디어 커먼즈에서 구할 수 있는 것 위주.

---

## 시대별 배경 이미지 (7개)
가로 넓은 이미지 추천 (1920x1080 이상). 섹션 배경에 opacity 0.12로 은은하게 깔림.

| 파일명 | 설명 |
|--------|------|
| `bg_ancient.jpg` | 파르테논 신전 또는 라파엘로 '아테네 학당' |
| `bg_medieval.jpg` | 고딕 성당 내부 (스테인드글라스 빛) |
| `bg_renaissance.jpg` | 피렌체 두오모 전경 또는 시스티나 천장 |
| `bg_romanticism.jpg` | 프리드리히 '안개 바다 위의 방랑자' |
| `bg_industrial.jpg` | 터너 '비, 증기, 그리고 속도' |
| `bg_nietzsche.jpg` | 뭉크 '절규' 또는 어두운 극장 무대 |
| `bg_modern.jpg` | 바우하우스 데사우 건물 또는 몬드리안 컴포지션 |

---

## 인물 이미지 (29개)
인물 카드 및 이벤트 상세에 사용. 정사각형 또는 세로형 권장 (400x500 이상).

| 파일명 | 인물 | 추천 소스 |
|--------|------|-----------|
| `thales.jpg` | 탈레스 | 흉상 또는 판화 |
| `pythagoras.jpg` | 피타고라스 | 흉상 |
| `socrates.jpg` | 소크라테스 | 대리석 흉상 |
| `plato.jpg` | 플라톤 | 흉상 |
| `aristotle.jpg` | 아리스토텔레스 | 흉상 |
| `kandinsky.jpg` | 칸딘스키 | 사진 초상 |
| `cicero.jpg` | 키케로 | 대리석 흉상 |
| `occam.jpg` | 윌리엄 오캄 | 중세 판화/삽화 |
| `gropius.jpg` | 발터 그로피우스 | 사진 초상 |
| `mies.jpg` | 미스 반데어로에 | 사진 초상 |
| `gutenberg.jpg` | 구텐베르크 | 판화 초상 |
| `davinci.jpg` | 다빈치 | 자화상 (붉은 분필) |
| `michelangelo.jpg` | 미켈란젤로 | 초상화 |
| `descartes.jpg` | 데카르트 | 프란스 할스 초상화 |
| `newton.jpg` | 뉴턴 | 갓프리 넬러 초상화 |
| `blake.jpg` | 윌리엄 블레이크 | 자화상 또는 토마스 필립스 초상 |
| `delacroix.jpg` | 들라크루아 | 자화상 |
| `rousseau.jpg` | 장자크 루소 | 초상화 |
| `turner.jpg` | 터너 | 자화상 |
| `schopenhauer.jpg` | 쇼펜하우어 | 초상화 |
| `ruskin.jpg` | 존 러스킨 | 사진 초상 |
| `nietzsche.jpg` | 니체 | 사진 초상 |
| `wagner.jpg` | 바그너 | 사진 초상 |
| `freud.jpg` | 프로이트 | 사진 초상 |
| `jung.jpg` | 칼 융 | 사진 초상 |
| `mucha.jpg` | 알퐁스 무하 | 사진 초상 |
| `picasso.jpg` | 피카소 | 사진 초상 |
| `mondrian.jpg` | 몬드리안 | 사진 초상 |
| `malevich.jpg` | 말레비치 | 사진 초상 |

---

## 작품/사건 이미지 (28개)
이벤트 카드 상세 및 사이드 패널에 사용. 가로형 권장 (800x600 이상).

| 파일명 | 작품/사건 | 작가/시기 |
|--------|-----------|-----------|
| `four_elements.jpg` | 4원소 도해 또는 일러스트 | 고대/중세 |
| `death_of_socrates.jpg` | 소크라테스의 죽음 | 자크 루이 다비드, 1787 |
| `black_square.jpg` | 검은 사각형 | 말레비치, 1915 |
| `kandinsky_book.jpg` | 점선면 책 표지 또는 관련 작품 | 칸딘스키, 1926 |
| `hagia_sophia.jpg` | 하기아 소피아 내부 | 537 완공 |
| `gothic.jpg` | 고딕 성당 (샤르트르/밀라노 두오모) | 12~16C |
| `bauhaus_manifesto.jpg` | 바우하우스 선언문 고딕 성당 판화 | 파이닝어, 1919 |
| `giotto.jpg` | 애도 (Lamentation) | 지오토, ~1305 |
| `birth_of_venus.jpg` | 비너스의 탄생 | 보티첼리, 1485 |
| `mona_lisa.jpg` | 모나리자 | 다빈치, 1503 |
| `school_of_athens.jpg` | 아테네 학당 | 라파엘로, 1509 |
| `copernicus.jpg` | 코페르니쿠스 초상 또는 태양계 도해 | 16C |
| `french_revolution.jpg` | 민중을 이끄는 자유의 여신 | 드라크루아, 1830 |
| `blake_newton.jpg` | 뉴턴 | 블레이크, 1795 |
| `raft_of_medusa.jpg` | 메두사호의 뗏목 | 제리코, 1819 |
| `liberty_leading.jpg` | 민중을 이끄는 자유의 여신 (상세) | 드라크루아, 1830 |
| `temeraire.jpg` | 전함 테메레르 | 터너, 1838 |
| `crystal_palace.jpg` | 수정궁 (Crystal Palace) | 1851 |
| `arts_crafts.jpg` | 예술공예운동 작품 (모리스 벽지 등) | ~1880s |
| `wagner_ring.jpg` | 니벨룽의 반지 무대 사진 | 바그너, 1876 |
| `zarathustra.jpg` | 차라투스트라 관련 (니체 초상 또는 책 표지) | 1885 |
| `starry_night.jpg` | 별이 빛나는 밤 | 고흐, 1889 |
| `matisse.jpg` | 마티스 작품 (춤 또는 종이 오려붙이기) | 1905~ |
